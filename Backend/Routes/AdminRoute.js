...
router.put("/api/edit-products", add_products_validator, edit_products)
router.delete("/api/delete-products", delete_products)
...
router.delete("/api/delete-user", delete_users)
