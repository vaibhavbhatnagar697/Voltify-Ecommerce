...
export default function OrderDetails() {
    ...
    async function particular_order() {
      try {
        const res = await fetch(
          `${import.meta.env.VITE_API_URL}/user/api/particular-order?order_id=${query}`,
          {
            method: "GET",
            headers: {
  ...
  async function order_details() {
    ...
    try {
      const res = await fetch(
        `${import.meta.env.VITE_API_URL}/user/api/order-details`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      if (data.success === true) {
        try {
          const response = await fetch(
            `${import.meta.env.VITE_API_URL}/user/api/payment-session`,
            {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
